...
describe("sitemap", () => {
  it("includes the home page", () => {
    ...
    const home = entries.find((e) => e.url === "https://youssef-writer.vercel.app");
  ...
  it("includes the privacy page", () => {
    ...
    const privacy = entries.find(
      (e) => e.url === "https://youssef-writer.vercel.app/privacy"
    );
  ...
  it("includes all portfolio detail pages", () => {
    ...
    const portfolioEntries = entries.filter((e) =>
      e.url.startsWith("https://youssef-writer.vercel.app/portfolio/")
    );
